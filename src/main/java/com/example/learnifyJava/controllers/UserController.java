...
import com.example.learnifyJava.services.UserService;
...
public class UserController {
    ...
    @PostMapping
    public ResponseEntity<?> save(@RequestBody User dataSentByClient){
        try{
            return ResponseEntity
                    .status(HttpStatus.CREATED)
                    .body(this.service.saveUser(dataSentByClient));
        } catch(Exception e){
            return ResponseEntity
